    ...
    if (req.body.Type === 'Notification' && req.body.Message) {
      ...
      if (message.notificationType === 'bounce') {
        ...
        for (const recipient of bounce.bouncedRecipients) {
          ...
          console.log(`Updated beneficiaries with email ${emailAddress} as invalid`);
        }
      }
      ...
      if (message.notificationType === 'complaint') {
        ...
        for (const recipient of complaint.complainedRecipients) {
          const emailAddress = recipient.emailAddress;
          console.log(`Marking email as invalid due to complaint: ${emailAddress}`);
          ...
          console.log(`Updated beneficiaries with email ${emailAddress} as invalid due to complaint`);
        }
      }
    }
